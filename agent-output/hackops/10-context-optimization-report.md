...
| `01-Conductor` during multi-phase sessions         | Between infra phase (Steps 1-7) and app phase (Steps A1-A9) | New chat session or delegate to `13-App Conductor`                     | ~60K tokens (domain shift)                  |
