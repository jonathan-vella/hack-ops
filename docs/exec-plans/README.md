...
A lightweight document that captures the intent, key decisions, and progress
of a multi-step initiative. Not every task needs one — use them for work that:
...
The [tech-debt-tracker.md](tech-debt-tracker.md) maintains a running inventory
of known quality gaps, technical debt, and planned remediation. It is updated
by the doc-gardening workflow and referenced by `QUALITY_SCORE.md`.
