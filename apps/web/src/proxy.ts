...
/** Page routes that require authentication (matched by prefix). */
const PROTECTED_PAGE_PREFIXES = ["/dashboard", "/admin", "/join"];
...
export function proxy(request: NextRequest) {
  ...
  // Protect authenticated page routes — redirect to landing page
