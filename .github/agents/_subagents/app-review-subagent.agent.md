...
description: Code review subagent for HackOps application code. Reviews against api-routes and typescript instruction standards and shadcn-ui-patterns skill. Returns APPROVED/NEEDS_REVISION with actionable findings.
model: "GPT-5.3-Codex"
