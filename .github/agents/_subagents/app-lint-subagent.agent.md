...
description: Runs TypeScript type-checking (tsc --noEmit) and ESLint on application code. Returns structured PASS/FAIL with error list. Called by App Builder and App Tester.
model: "GPT-5.3-Codex"
