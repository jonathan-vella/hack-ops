...
2. **Read** `.github/skills/golden-principles/SKILL.md` — operating principles
...
Save to `agent-output/{project}/10-context-optimization-report.md`:
...
- To use in another project: copy `.github/agents/10-context-optimizer.agent.md`,
