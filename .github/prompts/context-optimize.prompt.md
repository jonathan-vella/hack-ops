...
- Save the report to `agent-output/hackops/10-context-optimization-report.md`
...
Write the report to `agent-output/hackops/10-context-optimization-report.md`
...
- **File**: `agent-output/hackops/10-context-optimization-report.md`
