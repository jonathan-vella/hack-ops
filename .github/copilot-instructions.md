...
- Only use `gh` for operations without equivalent MCP write tools.
- In devcontainers, do not run `gh auth` unless explicitly requested.

### Context7 MCP (Auto-Invoke)

Always use Context7 MCP when I need library/API docs, code generation, or setup
guidance without explicit request.
